          ...
          {user ? (
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button type="button" className="flex w-[13rem] min-w-0 items-center gap-2.5 rounded-full border border-border bg-background py-1 pl-1 pr-3 text-left shadow-sm transition-colors hover:border-primary/35 hover:bg-secondary" aria-label="打开账号菜单">
              ...
              <DropdownMenuContent align="end" sideOffset={10} className="w-[22rem] max-w-[calc(100vw-2rem)] rounded-2xl border-border bg-popover p-2 text-popover-foreground shadow-[0_24px_70px_hsl(var(--foreground)/0.22)]">
                <DropdownMenuLabel className="relative overflow-hidden rounded-xl border border-border bg-secondary p-3.5">
          ...
          <nav aria-label="移动端导航" className="page-shell grid grid-cols-2 gap-1 py-4 sm:grid-cols-3">
            ...
            {user ? (
              <div className="col-span-2 mt-2 overflow-hidden rounded-2xl border border-border/80 bg-background p-2 shadow-[0_16px_38px_hsl(var(--foreground)/0.08)] sm:col-span-3">
                <div className="relative flex items-center gap-3 overflow-hidden rounded-xl border border-border bg-secondary p-3">
